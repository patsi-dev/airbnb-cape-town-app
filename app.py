...
# --- WORKING DATA URL (LATEST) ---
@st.cache_data
def load_data():
    # Latest working link from Inside Airbnb
    url = "https://data.insideairbnb.com/south-africa/wc/cape-town/2024-09-28/visualisations/listings.csv"
    df = pd.read_csv(url)
...
st.caption("Data: Inside Airbnb (Sep 2024) | Model: Random Forest")